...
<div id="main-container" class="container-fluid">
    <div class="row">
        <div class="offset-md-1 col-md-6 movie-container">
            ...
            allow="acceloremeter; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
         ...
         <div class="col-md-12" id="review-form-container">
            ...
            <form action="<?= $BASE_URL ?>review_process.php" id="review-form" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="rating" id="rating" class="form-group">
                ...
                <input type="submit" class="btn card-btn" value="Enviar o comentario"> 
            </form>
         </div>
         <?php endif; ?>
         <!-- Comentarios -->
        ...
        <?php if(empty($movieReviews)): ?>
            <p class="empty-list">Ainda não há nenhuma review...</p>
        <?php endif; ?>   
        </div>
    </div>
</div>
